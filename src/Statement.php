...
class Statement extends PDOStatement
{
     ...
     * @param Oci8 $connection The Pdo object for this statement
     * @param array $options Options for the statement handle
     * @throws PDOException
     */
    public function __construct($sth, Pdo $connection, array $options = array())
    {
    ...
    public function setCursor($cursorName)
    {
        ...
        oci_bind_by_name($this->sth, ":".$this->cursorName, $this->cursor, -1, OCI_B_CURSOR);
    }
    ...
    public function fetch($fetchMode = null, $cursorOrientation = PDO::FETCH_ORI_NEXT, $cursorOffset = 0)
    {
        ...
        switch ($fetchMode) {
            case PDO::FETCH_BOTH:
                $rs = oci_fetch_array($this->fetchStatement); // Fetches both; nice!
                if ($rs === false) {
                    return false;
                }
                if ($toLowercase) {
            ...
            case PDO::FETCH_NUM:
                $rs = oci_fetch_row($this->fetchStatement);
                if ($rs === false) {
                    return false;
                }
                if ($this->returnLobs && is_array($rs)) {
...
//        die();
    ...
    {
        throw new PDOException("bindColumn has not been implemented");
    }
    ...
    public function setFetchMode($fetchMode, $modeArg = null, $ctorArgs = array())
    {
        ...
        switch ($fetchMode) {
            ...
            case PDO::FETCH_COLUMN:
                ...
                break;
            default:
                throw new PDOException("Requested fetch mode is not supported " .
    ...
    {
        throw new PDOException("setFetchMode has not been implemented");
    }
